...
// Ảnh câu hỏi — pic/ gốc (36 file)
const STATIC_IMAGES_ROOT = [
  `${BASE}/pic/De-01-Cau-1.png`,
  `${BASE}/pic/De-05-Cau-1.png`,
  `${BASE}/pic/De-05-Cau-11.png`,
  `${BASE}/pic/De-05-Cau-2.png`,
  `${BASE}/pic/De-05-Cau-7.png`,
  `${BASE}/pic/De-05-Cau-8.png`,
  `${BASE}/pic/De-05-Cau-9.png`,
  `${BASE}/pic/De-05-Cau-II.1.png`,
  `${BASE}/pic/De-05-Cau-II.2.png`,
  `${BASE}/pic/De-05-Cau-II.4.a.png`,
  `${BASE}/pic/De-05-Cau-II.4.png`,
  `${BASE}/pic/De-05-Cau-III.1.png`,
  `${BASE}/pic/De-05-Cau-III.2.png`,
  `${BASE}/pic/De-05-Cau-III.5.png`,
  `${BASE}/pic/De-05-Cau-III.6.png`,
  `${BASE}/pic/De-06-Cau-02.png`,
  `${BASE}/pic/De-06-Cau-07.png`,
  `${BASE}/pic/De-06-Cau-11.png`,
  `${BASE}/pic/De-06-Cau-II.02.png`,
  `${BASE}/pic/De-06-Cau-III.05.png`,
  `${BASE}/pic/De-06-Cau-III.06.png`,
  `${BASE}/pic/De-07-Cau-01.png`,
  `${BASE}/pic/De-07-Cau-02.png`,
  `${BASE}/pic/De-07-Cau-08.png`,
  `${BASE}/pic/De-07-Cau-11.png`,
  `${BASE}/pic/De-07-Cau-12.png`,
  `${BASE}/pic/De-07-Cau-III.2.png`,
  `${BASE}/pic/De-07-Cau-III.3.png`,
  `${BASE}/pic/De-08-Cau-03.png`,
  `${BASE}/pic/De-08-Cau-04.png`,
  `${BASE}/pic/De-08-Cau-09.png`,
  `${BASE}/pic/De-08-Cau-12.png`,
  `${BASE}/pic/De-08-Cau-II.3.png`,
  `${BASE}/pic/De-08-Cau-II.4.png`,
  `${BASE}/pic/De-08-Cau-III.1.png`,
  `${BASE}/pic/De-08-Cau-III.3.png`,
